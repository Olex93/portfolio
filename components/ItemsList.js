...
const itemsList = [
    {
        ...
        text:"In order to display my work and demonstrate my skills, it became apparent that I would need a portfolio website. To that end, I designed and built this website from scratch. ",
        text2:"I decided to go with Next.js because of it's quick setup time, the ability to easly build universal SPA's and my familiarity with the framework.",
        key:1,
        category:"personal",
    ...
    },
    {
        ...
        text:"As part of the development of this portfolio website, I needed a nice, filterable and animated grid with modal popups to display my work. I had a look on NPM and asked friends in the React community, but there were no solutions that fitted what I wanted. ",
        text2:"I created this re-usable, responsive React filter grid using React and Framer Motion. The link above is to the CodeSandbox mockup which was the pre-requisite to this page.",
        key:2,
        category:"personal",
    ...
    },
    {
        ...
        subheading:"React, Next & Express Coded Website",
        text:"Working for Find The Lead local dog walking business in Cheltenham, I designed and built this site from the ground up. ",
        text2:"A prominent display of their Facebook account was key to the client, so I used a custom Express.js server to interface with the Facebook Graph API and retrieve their business page data. It was also important that the websit performed well, was fast and SEO optimised. I created an initial selection of design mockups. From there, I set to work using Next.js. ",
        text3:"I wanted to build the site as a progressive web application to create a simple and painless user experience. Next.js was selected due to it's built in performance features, such as pre-rendering, server-side rendering and automatic code-splitting. This ensured that the website performs well and ultimately improves the sites' SEO.",
        key:3,
        category:"corporate",
        type:"Freelance",
    ...
    },
    {
        ...
        text:"New custom coded website build from scratch due to a company change in direction. This simple sales website needed to look great on mobile above all else. I was responsible for the entire UI Design and implementation. ",
        text2:"Starting with the branded design, I created initial wireframes and mockups before beginning development. This site was built using Ejs template partials served by a custom Express.js server. Other technologies include Lodash, Body Parser, Bootstrap, Dotenv and Vanilla JS.",
        key:4,
        category:"corporate",
        type:"Freelance",
    ...
    },
    {
        ...
        text:"I created this note keeping web application (based on Google Keep), to further expand on my React skills. The project involves functional programming using react state manipulation and hooks. ",
        text2:"This project was set as a code challenge on the Full Stack Development course that I have completed.",
        key:5,
        category:"personal",
    ...
    },
    {
        ...
        text:"I re-created the classic Hasbro Simon game using Vanilla Javascript for this personal project to develop my Javascript skills. ",
        text2:"This project was set as a code challenge on the Full Stack Development course that I have completed.",
        key:6,
        category:"personal",
        ...
        text:"I created this simple single page static website using HTML, CSS & Bootstrap to solidify my understanding on using and customising Bootstrap. ",
        text2:"This project was set as a code challenge on the Full Stack Development course that I have completed.",
        key:7,
        category:"personal",
    ...
    },
    {
        ...
        text:"Whilst at VPI, working with designers & third party developers, I managed on-going optimisation of the company website structure & SEO, design implementation and performance optimisation.",
        text2:"The VPI website is built using Wordpress and a combination of plugins including Elementor, Advanced Custom Fields, LiteSpeed Cache and more. Unfortunately, the company is heavily embedded within these softwares / technologies, which was often limiting in terms of performance optimisation. ",
        text3:"Whilst not code heavy, this build gave me exposure to UX testing, SEO optimisation, design implementation & collaboration.",
        key:8,
        category:"corporate",
        type:"Employed",
    ...
    },
    {
        ...
        text:"Following my employment at Solar South West, I was asked by the company director if I could re-produce their existing website for a new brand. It was important that the same technologies were used, as some level of content management took place in house. ",
        text2:"I set up hosting and built out the website from scratch, rather than copying the old one over, due to outdated software. I stuck to Wordpress and the X Theme as it would leave employees with a level of control. ",
        text3:"This site has not been maintained and may now appear broken, dated and buggy.",
        key:9,
        category:"corporate",
        type:"Freelance",
        date:"October 2017",
    ...
    },
    {
        ...
        text:"Whilst employed at Solar South West I was involved in basic Wordpress design adjustments using Cornerstone. I was responsible for SEO optimisation and site-structure modification. ",
        text2:"This site has not been maintained and may now appear broken, dated and buggy.",
        key:10,
        category:"corporate",
        type:"Employed",
